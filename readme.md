...
## Простая и компактная библиотека для манипуляций с IPv4, IPv6-адресами, а так же 48-битными MAC-адресами стандарта Ethernet.
...
Хранение **48**-битного адреса в памяти требует числа **u64i** и обратного порядка следования октетов, что нужно учитывать. Чтобы исключить путаницу и критические ошибки при индексации, были созданы константы **`macmnp::oct1 - oct6`** :
