...
Не использует собственных exceptions (кроме исключений классов STL). Рассчитана на архитектуру **Intel/AMD x64** и компилятор **GCC**, но возможно заработает на Visual C++ с некоторыми доработками.
