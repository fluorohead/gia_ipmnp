...
Флаг **flag_show_ipv4** крайне важно выставлять в **false** для объектов класса **IPv6_Mask** - это гарантирует правильное отображение при конвертации в string. В ином случае все маски с **0xFFFF** в **6-м хекстете** расцениваются, как IPv6-адреса, имеющие **интегрированый IPv4 (RFC 4291)**.
