...
## Простая и компактная библиотека для работы и манипуляций с IPv4/IPv6-адресами, а так же 48-битными MAC-адресами стандарта Ethernet.
...
-
**Возвращает адрес массивом из 6 элементов типа u8i в порядке следования байтов, как в среде передачи данных (старшие октеты передаются первыми)**:

    array<u8i,6> to_media_tx()
